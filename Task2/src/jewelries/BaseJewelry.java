...
public class BaseJewelry {
    ...
    public void deleteStoneByObject(Stone stoneToDelete) throws JewelryFactoryException {
        ...
        if (tempSize == stones.size()) throw new JewelryFactoryException(ErrorMessages.IMPOSSIBLE_TO_DELETE_MSG);
    }
    ...
    public List<Stone> getStonesByWeight(double min, double max) throws JewelryFactoryException {
        ...
        if (tempArray.size() == 0) throw new JewelryFactoryException(ErrorMessages.EMPTY_ARRAY_TO_RETURN_MSG);
        return tempArray;
    }
